 ...
 *
 * <p>This package provides components for classifying errors, implementing retry strategies, and
 * managing error recovery in transport operations.
 *
 * <h2>Key Components</h2>
 *
 * <ul>
 *   <li>{@link express.mvp.myra.transport.error.ErrorCategory} - Classification of error types
 *   <li>{@link express.mvp.myra.transport.error.ErrorClassifier} - Classifies exceptions by
 *       category
