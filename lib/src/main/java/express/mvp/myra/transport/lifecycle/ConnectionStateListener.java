 ...
 *
 * <p>Implementations receive notifications when a connection transitions between states, allowing
 * applications to react to connectivity changes.
 *
 * <h2>Usage Example</h2>
 *
 * <pre>{@code
 ...
 * <h2>Thread Safety</h2>
 *
 * <p>Callbacks may be invoked from different threads. Implementations should be thread-safe and
 * non-blocking to avoid stalling the transport.
 *
...
public interface ConnectionStateListener {
     ...
     *
     * <p>This callback is invoked synchronously during the state transition. Implementations should
     ...
     */
    void onStateChanged(
            ConnectionState previousState, ConnectionState currentState, Throwable cause);
